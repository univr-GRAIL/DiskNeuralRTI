...
## Training  
    ...
    The output contains:
        ...
        The image planes and JSON file used for interactive relighting using the [https://github.com/cnr-isti-vclab/openlime openlime](https://github.com/cnr-isti-vclab/openlime) web visualizer.
## Run   
    python train.py  
